---
layout: auth0
title: "Build a Blog with Gatsby, React and Webtask.io!"
...
categories: [tutorial, gatsby, react, javascript]
tags: [auth0, tutorial, gatsby, react, javascript]
cover: building-a-blog-with-gatsby-react-and-webtask.png
cover_bg: 2B1743
author: luke
canonical_url: https://auth0.com/blog/building-a-blog-with-gatsby-react-and-webtask/
---

In this article, we're going to be building a blog, and adding extra features like pagination, user authentication with [Auth0.js](https://auth0.com/docs/libraries/auth0js), and newsletter subscription using an API endpoint built on [Webtask.io](https://webtask.io).

[Gatsby](https://www.gatsbyjs.org/) is a modern [React](https://reactjs.org/) based static content generator, and it boasts an [impressive list](https://www.gatsbyjs.org/features/#legend) of out-the-box features. 
...
![Node versions for Gatsby](node-versions-for-gatsby.png)
...
![Gatsby CLI building new project](cli-building-new-gatsby-project.png)
...
![Gatsby development server first run](gatsby-development-server-first-run.png)

And it should look *something* like this!

![Basic Gatsby install](basic-gatsby-install.png)
...
![Broken Gatsby homepage](broken-gatsby-homepage.png)
...
![Paginated Gatsby page 1](gatsby-paginated-page-1.png)

![Paginated Gatsby page 2 broken](gatsby-paginated-page-2-broken.png)
...
![Paginated Gatsby page 2 fixed](gatsby-paginated-page-2-fixed.png)
...
![Gatsby Blog Auth0 login box](auth0-login-box.png)
...
![Nav added to Gatsby blog](nav-added-to-gatsby.png)

And now when we log in, our application now knows who we are.

![Logged into the Gatsby blog](logged-into-the-gatsby-blog.png)
...
![Webtask CLI setup](webtask-cli-setup.png)
...
![Webtask in editor](webtask-in-editor.png)
...
![Logged in and unsubscribed](logged-in-unsubscribed.png)

Now subscribe to the newsletter!

![Logged in and subscribed](logged-in-subscribed.png)
